...
#
#   bash desktop-extension/build.sh    ->  desktop-extension/threads-<version>.mcpb
set -euo pipefail
...
npx -y @anthropic-ai/mcpb@latest pack "$build" "$root/desktop-extension/threads-$version.mcpb"

echo
echo "Built desktop-extension/threads-$version.mcpb"
